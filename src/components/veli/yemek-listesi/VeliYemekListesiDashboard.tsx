...
interface VeliYemekListesiDashboardProps {
    userId: string
    ogrenciId: string
}

export function VeliYemekListesiDashboard({
    userId,
    ogrenciId,
}: VeliYemekListesiDashboardProps) {
    const {
        document,
        isLoading,
        error,
    ...
    return (
        <div className="container mx-auto py-6">
            <div className="mb-6">
                ...
                <p className="text-gray-600 mt-1">Çocuğunuzun yemek menüsünü görüntüleyin</p>
            </div>
