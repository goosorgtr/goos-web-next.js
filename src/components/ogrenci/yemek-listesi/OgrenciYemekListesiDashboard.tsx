...
interface OgrenciYemekListesiDashboardProps {
    userId: string
    ogrenciId: string
}

export function OgrenciYemekListesiDashboard({
    userId,
    ogrenciId,
}: OgrenciYemekListesiDashboardProps) {
    const {
        document,
        isLoading,
        error,
    ...
    return (
        <div className="container mx-auto py-6">
            <div className="mb-6">
                ...
                <p className="text-gray-600 mt-1">Bu haftanın yemek menüsünü görüntüleyin</p>
            </div>
