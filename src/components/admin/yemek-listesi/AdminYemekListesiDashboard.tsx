...
interface AdminYemekListesiDashboardProps {
    userId: string
}

export function AdminYemekListesiDashboard({ userId }: AdminYemekListesiDashboardProps) {
    const {
        document,
        isLoading,
        error,
    ...
    return (
        <div className="container mx-auto py-6">
            <div className="mb-6">
                <h1 className="text-2xl font-bold text-gray-900">Haftalık Yemek Listesi</h1>
                <p className="text-gray-600 mt-1">Okulun haftalık yemek programını görüntüleyin</p>
            </div>
